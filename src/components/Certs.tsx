            ...
            <div className="lg:flex lg:justify-center lg:items-center">
                <div className=" lg:mx-auto lg:w-[70%] lg:mt-20 md:mx-auto md:mt-20   md:ml-10  mt-20">
                    ...
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-x-9 gap-2 items-start mt-10 gap-y-9 mx-4  md:mx-0">
                        <div className="cert border dark:hover:bg-zinc-900 hover:bg-gray-50 border-gray-200 dark:border-zinc-900 dark:text-zinc-400  rounded-md px-4 py-3 flex items-center space-x-2 lg:w-[98%]  w-full  relative">
        ...
        `}
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <span>
                                    ...
                                    <span className="text-white dark:text-zinc-950 dark:hover:text-zinc-900">
                                        - Associate
                                    </span>
                                </span>
                            </div>
...
`}
        ...
        `}
                            ...
                            <div className="absolute top-2 right-2">
                                <a
                                    href="https://www.credly.com/badges/a1a39ba6-4746-4386-8142-2dfadb731977"
                                    target="_blank"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="cert border dark:hover:bg-zinc-900 hover:bg-gray-50 border-gray-200 dark:border-zinc-900 dark:text-zinc-400 rounded-md px-4 py-3 flex items-center space-x-2 lg:w-[98%]  w-full relative">
                            <div className="bg-slate-100 p-3 rounded-[0.25rem]">
                                ...
                                >
                                    <path
                                        fill="#5C4EE5"
                                        d="M128 0L256 74.67v106.67L128 256 0 181.33V74.67L128 0z"
                                    />
                                    <path
                                        fill="#FFFFFF"
                                        d="M77.867 60.8L128 89.6l50.133-28.8v57.6L128 147.2 77.867 118.4V60.8zm0 76.8L128 166.4l50.133-28.8v57.6L128 224 77.867 195.2v-57.6z"
                                    />
                                </svg>
                            </div>
                            <div className="flex flex-col items-start">
                            ...
                            <div className="absolute top-2 right-2">
                                <a
                                    href="https://www.credly.com/badges/d5af80ba-0d38-4885-ac3a-cd9297790cdb"
                                    target="_blank"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
