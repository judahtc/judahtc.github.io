const MovingSkills = () => {
    return (
        <div className="px-4 lg:px-0  bg-gray-50 dark:bg-transparent dark:text-white md:py-36 md:mt-24 lg:py-36 lg:mt-24 py-20 mt-24 text-gray-400  shadow-sm w-[99%]">
